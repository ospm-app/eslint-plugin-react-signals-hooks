...
export default [
  ...
  },
  {
    ...
    rules: {
      // The import plugin can crash when analyzing flat-config files' export default
      // Disable module usage checks for the config file itself
  ...
  // Ensure the import plugin's no-unused-modules is OFF for flat config files.
  // This must be last so it overrides earlier spreads like commonRules/jsConfig.
  {
    files: ['**/eslint.config.{js,mjs}'],
    rules: {
      'import/no-unused-modules': 'off',
