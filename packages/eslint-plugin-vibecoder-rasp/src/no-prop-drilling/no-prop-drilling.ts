...
export const noPropDrilling = createRule<Options, MessageIds>({
	...
	meta: {
		...
		docs: {
			description:
				"Prevent prop drilling by enforcing a maximum depth for prop passing",
	...
	create(context, [options]) {
		...
		function getPropName(
			prop: TSESTree.Node | null | undefined,
		): string | null {
			if (!prop) return null;
