...
export function TestAutoFixUseMemo(): JSX.Element {
  ...
  }, [counterSignal.value]); // Missing counterSignal.value and nameSignal.value.length - should be auto-fixed

  return <View>{expensiveValue}</View>;
}

export function TestAutoFixUseCallback(): JSX.Element {
...
export function TestNoAutoFixUseEffect(): JSX.Element {
