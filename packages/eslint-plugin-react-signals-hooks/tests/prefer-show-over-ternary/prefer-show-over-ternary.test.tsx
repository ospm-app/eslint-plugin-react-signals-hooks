...
export function TestComplexTernaryWithSignal(): JSX.Element {
  ...
  try {
    ...
    // This should trigger a warning - complex ternary with boolean signal condition
    return (
      <div>
        {visibleSignal ? (
          <div>
...
export function TestTernaryWithComplexConsequent(): JSX.Element {
  ...
  try {
    ...
    // This should trigger a warning - complex consequent with boolean signal condition
    return (
      <div>
        {loadingSignal ? (
...
export function TestTernaryWithComplexAlternate(): JSX.Element {
  ...
  try {
    ...
    // This should trigger a warning - complex alternate with boolean signal condition
    return (
      <div>
        {errorSignal ? (
          <span>Error</span>
...
export function TestNestedTernaryWithSignals(): JSX.Element {
  ...
  try {
    ...
    // This should NOT trigger a warning - nested ternary without boolean signal conditions
    return (
      <div>
...
export function TestTernaryWithLogicalSignal(): JSX.Element {
  ...
  try {
    ...
    // This should NOT trigger a warning - logical expression with signal.value in ternary
    return (
      <div>
        {userSignal.value?.isLoggedIn === true ? (
...
export function TestCustomComplexityTernary(): JSX.Element {
  ...
  try {
    ...
    // This should NOT trigger a warning, cos signal is not boolean
    return (
      <div>
...
export const TestArrowFunctionComplexTernary = (): JSX.Element => {
  ...
  try {
    ...
    // This should NOT trigger a warning - Show's when accepts Signal<boolean> only.
    return (
      <div>
