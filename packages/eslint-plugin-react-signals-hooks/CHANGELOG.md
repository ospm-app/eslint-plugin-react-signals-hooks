...
- `prefer-use-computed-in-react-component`
  - Encourages using `useComputed(...)` inside React components when appropriate.
  - Provides auto-fix to add or remove the `useComputed` import when necessary.

- `prefer-use-signal-effect-in-react-component`
  - Encourages using `useSignalEffect(...)` inside React components when appropriate.
  - Provides auto-fix to add or remove the `useSignalEffect` import when necessary.
