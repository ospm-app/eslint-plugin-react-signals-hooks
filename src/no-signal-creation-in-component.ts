...
function getNodeText(node: TSESTree.Node, context: Readonly<RuleContext<MessageIds, []>>): string {
  try {
 ...
 */
export const noSignalCreationInComponentRule = createRule<[], MessageIds>({
  ...
  create(context: Readonly<RuleContext<MessageIds, []>>): ESLintUtils.RuleListener {
